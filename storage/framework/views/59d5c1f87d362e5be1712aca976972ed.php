...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('tasks.create')); ?>" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg flex items-center">
    ...
    <?php if($tasks->isEmpty()): ?>
        <div class="bg-white rounded-lg shadow p-6 text-center">
            ...
            <a href="<?php echo e(route('tasks.create')); ?>" class="text-blue-500 hover:text-blue-600 font-medium">Create a task →</a>
        </div>
    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\resources\views/tasks/index.blade.php ENDPATH**/ ?>